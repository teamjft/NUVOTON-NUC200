 ...
 * $Revision: 7 $
 * $Date: 12/08/07 5:37p $
 * @brief    NUC200 Series PWM Generator and Capture Timer Driver Header File
 *
 * @note
...
#define PWM_PCR_PWM01TYPE_EDGE_ALIGNED      0                               /*!< PCR setting for PWM01 Edge-aligned type */
#define PWM_PCR_PWM01TYPE_CENTER_ALIGNED    (1UL << PWM_PCR_PWM01TYPE_Pos)  /*!< PCR setting for PWM01 Center-aligned type */
#define PWM_PCR_PWM23TYPE_EDGE_ALIGNED      0                               /*!< PCR setting for PWM23 Edge-aligned type */
...
#define PWM_PIER_INT01TYPE_PERIOD_COUNTER_MATCH_CNR (1UL << PWM_PIER_INT01TYPE_Pos) /*!< PIER setting for channel 0/1 Timer interrupt type to counter matches CNR */
#define PWM_PIER_INT01TYPE_PERIOD_COUNTER_UNDERFLOW (1UL << PWM_PIER_INT01TYPE_Pos) /*!< PIER setting for channel 0/1 Timer interrupt type to counter underflow */
#define PWM_PIER_INT23TYPE_PERIOD_COUNTER_MATCH_CNR (1UL << PWM_PIER_INT23TYPE_Pos) /*!< PIER setting for channel 2/3 Timer interrupt type to counter matches CNR */
#define PWM_PIER_INT23TYPE_PERIOD_COUNTER_UNDERFLOW (1UL << PWM_PIER_INT23TYPE_Pos) /*!< PIER setting for channel 2/3 Timer interrupt type to counter underflow */
...
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_POE_POE0_ENABLE  (1UL << PWM_POE_POE0_Pos) /*!< POE setting for Channel 0 PWM Output Enable */
#define PWM_POE_POE1_ENABLE  (1UL << PWM_POE_POE1_Pos) /*!< POE setting for Channel 1 PWM Output Enable */
#define PWM_POE_POE2_ENABLE  (1UL << PWM_POE_POE2_Pos) /*!< POE setting for Channel 2 PWM Output Enable */
#define PWM_POE_POE3_ENABLE  (1UL << PWM_POE_POE3_Pos) /*!< POE setting for Channel 3 PWM Output Enable */

/*---------------------------------------------------------------------------------------------------------*/
/*  TCON constants definitions                                                                              */
/*---------------------------------------------------------------------------------------------------------*/
#define PWM_TCON_PWM0TEN_ENABLE  (1UL << PWM_TCON_PWM0TEN_Pos) /*!< TCON setting for Channel 0 PWM trigger ADC Enable in Center-Aligned Trigger */
#define PWM_TCON_PWM1TEN_ENABLE  (1UL << PWM_TCON_PWM1TEN_Pos) /*!< TCON setting for Channel 1 PWM trigger ADC Enable in Center-Aligned Trigger */
#define PWM_TCON_PWM2TEN_ENABLE  (1UL << PWM_TCON_PWM2TEN_Pos) /*!< TCON setting for Channel 2 PWM trigger ADC Enable in Center-Aligned Trigger */
#define PWM_TCON_PWM3TEN_ENABLE  (1UL << PWM_TCON_PWM3TEN_Pos) /*!< TCON setting for Channel 3 PWM trigger ADC Enable in Center-Aligned Trigger */
 ...
 *
 * @note       PBCR register must be set to 1 for specified capture group to prevent CFLRIx/CRLRIx is cleared when writing CCR0/CCR2
 *
 */
 ...
 *              - PBCR register must be set to 1 for specified capture group to prevent CFLRIx/CRLRIx is cleared when writing CCR0/CCR2
 *
 */
 ...
 *
 */
#define _PWM_ENABLE_PWM_OUT(PWM,u32Ch) ((PWM)->POE |= (PWM_POE_POE0_Msk<<(u32Ch)))
 ...
 *
 */
#define _PWM_DISABLE_PWM_OUT(PWM,u32Ch) ((PWM)->POE&= ~(PWM_POE_POE0_Msk<<(u32Ch)))
 ...
 * @return      None
 *
 * @details     This function is used to enable timer trigger ADC to start conversion when PWM counter up count to CNR
 *
 * @note        This function only support when PWM operating at center-aligned mode  
 *
 */
...
/**
 * @brief       Disable timer period trigger ADC function in center-aligned type for specified channel
 *
 * @param[in]   PWM            PWM group 
 *                             - PWMA : PWM Group A
 *                             - PWMB : PWM Group B 
 ...
 * @return      None
 *
 * @details     This function is used to disable timer trigger ADC to start conversion when PWM counter up count to CNR
 *
 * @note        This function only support when PWM operating at center-aligned mode  
 *
 */
...
/**
 * @brief       Get timer trigger ADC to start conversion flag interrupt flag
 *
 * @param[in]  PWM            PWM group 
 *                            - PWMA : PWM Group A
 *                            - PWMB : PWM Group B 
 ...
 *                            - PWM_CH2
 *                            - PWM_CH3      
 * @retval      0             The specified channel timer trigger ADC to start conversion flag is not set 
 * @retval      1             The specified channel timer trigger ADC to start conversion flag is set
 *
 * @details    This function is used to get timer trigger ADC to start conversion flag interrupt flag
 *
 */
