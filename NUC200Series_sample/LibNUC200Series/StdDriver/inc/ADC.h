 ...
 * $Revision: 5 $
 * $Date: 12/08/08 4:53p $
 * @brief    NUC200 Series ADC Driver Header File
 *
 * @note
...
#define ADC_ADCR_TRGS_STADC             (0UL<<ADC_ADCR_TRGS_Pos)     /*!< STADC external pin trigger */
#define ADC_ADCR_TRGS_PWM_TRG           (3UL<<ADC_ADCR_TRGS_Pos)     /*!< PWM center-aligned trigger */
 ...
 *             In NuMicro NUC200 Series, it only needs 21 ADC clocks to complete
 *             an A/D conversion when the ADC clock source is HCLK.
 */
