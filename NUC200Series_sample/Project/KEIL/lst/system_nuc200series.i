#line 1 "..\\..\\LibNUC200Series\\CMSIS\\CM0\\DeviceSupport\\Nuvoton\\NUC200Series\\system_NUC200Series.c"
...
#line 7 "..\\..\\LibNUC200Series\\CMSIS\\CM0\\DeviceSupport\\Nuvoton\\NUC200Series\\system_NUC200Series.c"
...
#line 8 "..\\..\\LibNUC200Series\\CMSIS\\CM0\\DeviceSupport\\Nuvoton\\NUC200Series\\system_NUC200Series.c"
...
uint32_t gau32ClkSrcTbl[] = {(12000000UL), (32768UL), (50000000UL), (10000UL), (22118400UL)};
...
void SystemCoreClockUpdate (void)             
{
    ...
    u32ClkSrc = ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (7ul << 0);
    ...
    u32HclkDiv = (((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV & (0xFul << 0)) + 1; 
...
void SystemInit (void)
{
    ...
    PllClock = 0;
    i8IsPllEn = 0;
    u32HclkSelect = ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 & (7ul << 0);
    if(u32HclkSelect == 0x00UL)
    {
         
        ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON = (0x00000000UL | (((3)-2)<<9) | ((25)-2) | 0x4000UL);       
        
         
        i32TimeoutCnt = ((12000000UL) / 1000);  
        while((((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (1ul << 2)) == 0 )
        {
            if(i32TimeoutCnt-- <= 0)
                break;    
        }
    ...
    else if(u32HclkSelect == 0x07UL)
    {
         
        ((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCON = (0x00080000UL | (((13)-2)<<9) | ((59)-2) | 0x4000UL);       
        
         
        i32TimeoutCnt = ((22118400UL) / 1000);  
        while((((SYSCLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSTATUS & (1ul << 2)) == 0 )
        {
            if(i32TimeoutCnt-- <= 0)
                break;    
