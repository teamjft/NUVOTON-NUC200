 ...
 * $Revision: 2 $
 * $Date: 8/07/12 11:34a $ 
 * @brief    NUC200 Series UAC HID System API Header File
 *
 * @note
...
#define E_UAC_NULL_POINTER        -1
#define E_UAC_BUFFER_OVERRUN      -2
#define E_UAC_INVALID_EP_NUM      -3
#define E_UAC_CTRL_REG_TAB_FULL   -4
#define E_UAC_SAMPLE_NOT_SUPPORT  -5
#define E_HID_NULL_POINTER        -6
#define E_UAC_UNDEFINE            -100
