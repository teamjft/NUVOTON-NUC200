...
void RS485_HANDLE()  
{
    ...
    volatile uint32_t u32IntSts = ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->ISR;;
    
    if((u32IntSts & (1ul << 10))&&(u32IntSts & (1ul << 8)))              
    {   
        if(((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FSR & (1ul << 3))   
        {   
            addr = ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->DATA;
            ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FSR |= (1ul << 3));         
            printf("\nAddr=0x%x,Get:",addr);


	  		 
             
		  	if (( addr == 0xC0)||( addr == 0xA2))
		  	{
                ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FCR &= ~ (1ul << 8);   
	  		}
		  	else
		  	{
                printf("\n");
				((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FCR |= (1ul << 8);	   
                ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->FCR |= (1ul << 1);        
		  	}

        }
    }
    else if((u32IntSts & (1ul << 8)) || (u32IntSts & (1ul << 12)) )     
    {
         
        printf("%2d,",((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->RBR);
    }

    else if(u32IntSts & (1ul << 13))      
    {
        printf("\nBuffer Error...\n");
...
void RS485_SendAddressByte(uint8_t u8data)
{
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->LCR = ((3) | (0x5 << 3) | (0x0 << 2)));
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->THR = (u8data));
}

void RS485_SendDataByte(uint8_t *pu8TxBuf, uint32_t u32WriteBytes)
{
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->LCR = ((3) | (0x7 << 3) | (0x0 << 2)));
    UART_Write(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),pu8TxBuf,u32WriteBytes);
}
...
void RS485_9bitModeMaster()
{
    ...
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FUN_SEL = ((0x3 << 0)));
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->ALT_CSR = (1ul << 10);    
...
void RS485_9bitModeSlave()
{
    ...
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->LCR = ((3) | (0x3 << 3) | (0x0 << 2)));   

     
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FCR = ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FCR & ~(0xFul << 4))| ((0x0 << 4)));
        ...
        ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->ALT_CSR = (1ul << 8) | 
                         (1ul << 15) ;
#line 189 "..\\RS485.c"
    ...
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->IER |= (((1ul << 0) | (1ul << 2) | (1ul << 4))));
    ...
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FCR |= ((1ul << 2)|(1ul << 1)));
