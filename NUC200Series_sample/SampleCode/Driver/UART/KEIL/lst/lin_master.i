...
extern uint8_t g_u8RecData[1024];
...
void LIN_FunctionTest()
{
    ...
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->BAUD = ((1ul << 29) | (1ul << 28)) | (((50000000 + (20000/2)) / 20000)-2);

     
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FUN_SEL = ((0x1 << 0)));
    ...
    do{
        ...
        switch(u32Item)
        {
            ...
            case '2':   LIN_MasterTest(0x35,2);  break;
            case '3':   LIN_MasterTest(0x12,1); break;
            default:    break;
        }
    }while(u32Item != 27); 
    
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FUN_SEL = ((0x0 << 0)));
...
void LIN_FunctionTestUsingLinCtlReg(void)
{
    ...
    do{
        ...
        switch(u32Item)
        {
            case '1':   LIN_SendHeaderUsingLinCtlReg(0x30,(0x2UL << 22)); break;
            case '2':   LIN_MasterTestUsingLinCtlReg(0x35,2);  break;
            case '3':   LIN_MasterTestUsingLinCtlReg(0x12,1); break;
            default:    break;
        }
    }while(u32Item != 27); 
    
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->LIN_CTL&= ~(0x3ul << 22); 
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FUN_SEL = ((0x0 << 0)));
...
void LIN_MasterTestUsingLinCtlReg(uint32_t u32id,uint32_t u32ModeSel)
{
    uint8_t au8TestPattern[9] ={0x1,0x2,0x3,0x4,0x5,0x6,0x7,0x8,0x0}; 
    uint32_t i;

    if(u32ModeSel == 2)
    {
    	 
    	LIN_SendHeaderUsingLinCtlReg(u32id, (0x2UL << 22));
         
        au8TestPattern[8] = ComputeChksumValue(&au8TestPattern[0],8);
        UART_Write(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),&au8TestPattern[0],9);         
    }
    else if(u32ModeSel == 1)
    {
    	 
    	LIN_SendHeaderUsingLinCtlReg(u32id, (0x1UL << 22));  
         
        for(i=0; i<8; i++)  
    	    g_u8SendData[g_i32pointer++] = au8TestPattern[i]; 
              
        g_u8SendData[g_i32pointer++] = ComputeChksumValue(&g_u8SendData[0],9) ;        
        UART_Write(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),&g_u8SendData[1],9);
    }    		
}
...
void LIN_SendHeader(uint32_t u32id)
{
    ...
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->ALT_CSR = (11) | (1ul << 7));
	g_u8SendData[g_i32pointer++] = 0x55 ;                  
	g_u8SendData[g_i32pointer++] = GetParityValue(u32id);   
    UART_Write(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),g_u8SendData,2);	
}
...
void LIN_SendHeaderUsingLinCtlReg(uint32_t u32id, uint32_t u32HeaderSel)
{
    ...
    if(u32HeaderSel == (0x2UL << 22))
    {
        ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->LIN_CTL = ((u32id) << 24) | (0x2UL << 22) |
                         (((1)-1) << 20) | (((12)-1) << 16) | (1ul << 9); 
                              
        ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->LIN_CTL|= (1ul << 8);   
         
        while((((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->LIN_CTL&(1ul << 8)) == (1ul << 8));
    }
    


     
    else if(u32HeaderSel == (0x1UL << 22))
    {
        ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->LIN_CTL = (0x1UL << 22) | (((1)-1) << 20) | (((12)-1) << 16); 
    	...
    	g_u8SendData[g_i32pointer++] = GetParityValue(u32id);   
        UART_Write(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),g_u8SendData,1);                      
    }   
    


      
    else if(u32HeaderSel == (0x0UL << 22))
    {
        ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->LIN_CTL = (0x0UL << 22) | (((1)-1) << 20) | (((12)-1) << 16); 
...
void LIN_SendResponse(int32_t checkSumOption,uint32_t *pu32TxBuf)
{
	...
	UART_Write(((UART_T *) ((( uint32_t)0x40100000) + 0x50000)),g_u8SendData+2,9);	
}
...
void LIN_SendResponseWithByteCnt(int32_t checkSumOption,uint32_t *pu32TxBuf, uint32_t u32ByteCnt)
{
    ...
    if(checkSumOption == 2)
	    g_u8SendData[g_i32pointer++] = GetCheckSumValue(&g_u8SendData[2], u32ByteCnt) ;  
    else if(checkSumOption == 1)
	    g_u8SendData[g_i32pointer++] = GetCheckSumValue(&g_u8SendData[1], (u32ByteCnt+1)) ;  
