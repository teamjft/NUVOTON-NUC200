...
void IrDA_FunctionTxTest()
{
    ...
    ((UART_T *) ((( uint32_t)0x40100000) + 0x50000))->BAUD = (0) | (((50000000 + (115200*8)) / 115200 >> 4)-2);
    
     
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->FUN_SEL = ((0x2 << 0)));

     
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->IRCR = (1ul << 1)|((0)<<5));
    ...
    do
    {
        ...
        ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->THR = (u8OutChar));
    }while(u8OutChar !='0');
...
void IrDA_FunctionRxTest()
{
    ...
    ((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->IRCR = (1)<<6);
    ...
    do
    {
        if( (((((UART_T *) ((( uint32_t)0x40100000) + 0x50000)))->ISR & (1ul << 0))>>0))
        {
