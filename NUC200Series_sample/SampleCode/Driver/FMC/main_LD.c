 ...
 * $Revision: 4 $
 * $Date: 12/08/03 8:46p $ 
 * @brief    NUC200 Series Flash Memory Controller Driver Sample Code on LDROM
 *
 * @note
...
/*---------------------------------------------------------------------------------------------------------*/
    ...
    PllClock        = __IRC22M;            // IRC22M
    SystemCoreClock = __IRC22M / 1;        // HCLK
    CyclesPerUs     = __IRC22M / 1000000;  // For SYS_SysTickDelay()
